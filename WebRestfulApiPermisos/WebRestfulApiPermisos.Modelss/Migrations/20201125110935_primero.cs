...
namespace WebRestfulApiPermisos.Modelss.Migrations
{
    public partial class primero : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    idPermissionType = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    description = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypePermissions", x => x.idPermissionType);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    employerLastName = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permissions_TypePermissions_idPermissionType",
                        column: x => x.idPermissionType,
                        principalTable: "TypePermissions",
                        principalColumn: "idPermissionType",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.InsertData(
                table: "TypePermissions",
                columns: new[] { "idPermissionType", "description" },
                values: new object[] { 1, "SOPORT" });

            migrationBuilder.InsertData(
                table: "TypePermissions",
                columns: new[] { "idPermissionType", "description" },
                values: new object[] { 2, "ASISTENT" });
